...
```powershell
python scripts/run_sequential_credit_audit.py --phase diagnose
python scripts/run_sequential_credit_audit.py --phase dry-run --smoke-states 2 `
...
```bash
python3 scripts/run_sequential_credit_audit.py --phase all --workers 4 \
