...
from research.studies.representation.model_capacity_audit import (
    CAPACITY_ORDER,
    _diagnosis,
    _validate_config,
...
from research.studies.policy.ranking_objective_confirmation import (
...
class ModelCapacityAuditTests(unittest.TestCase):
    ...
    def test_capacity_validation_can_unlock_registered_confirmation_generator(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            with mock.patch(
                "research.studies.policy.ranking_objective_confirmation.generate_dataset",
