...
from research.studies.neighborhood.realized_ranking_confirmation import (
    _dataset_design,
    _evaluation_worker,
    _proposal_seed,
    _proposal_worker,
...
from research.studies.neighborhood.realized_ranking_confirmation_analysis import _acceptance
...
class ConfirmationTests(unittest.TestCase):
    ...
    def test_proposal_worker_is_outcome_blind_and_state_preserving(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch(
                "research.studies.neighborhood.realized_ranking_confirmation._make_environment",
