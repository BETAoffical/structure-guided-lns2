...
public:
    ...
    LNS(const Instance& instance, double time_limit,
        ...
        int screen, PIBTPPS_option pipp_option, bool repair_only = false,
        NeighborhoodPolicy* repair_policy = nullptr, RepairObserver* repair_observer = nullptr,
...
private:
    ...
    bool repair_only = false;
    NeighborhoodPolicy* repair_policy = nullptr;
    RepairObserver* repair_observer = nullptr;
    int max_repair_iterations = 0;
