...
from experiments.stride_structpool_ttf_fresh import (  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run the preregistered StructPool fresh-map raw-TTF evaluation."
    )
    ...
    if arguments.command == "analyze":
        report = analyze_structpool_ttf_fresh(arguments.config, arguments.output)
    else:
        report = run_structpool_ttf_fresh(
            arguments.config,
            arguments.output,
