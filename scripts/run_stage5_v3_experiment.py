...
from generators.stage5_v3 import run_stage5_v3_experiment  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Run legacy, controlled, kNN-guided, and ranker-guided "
    ...
    parser.add_argument("--ranker-config", required=True)
    ...
    summary = run_stage5_v3_experiment(
        dataset=arguments.dataset,
        solver=arguments.solver,
        ranker=arguments.ranker,
        ranker_config=arguments.ranker_config,
