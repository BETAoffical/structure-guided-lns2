...
from experiments.stride_structpool_lean_quick import (  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run the paired official/V2/full-StructPool/LeanPool raw-TTF Quick."
    )
    ...
    if arguments.command == "analyze":
        report = analyze_structpool_lean_quick(arguments.config, arguments.output)
    else:
