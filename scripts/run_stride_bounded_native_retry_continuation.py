...
from experiments.stride_bounded_native_retry_continuation import (  # noqa: E402
    analyze_collection,
    run_collection,
)
...
def main() -> int:
    ...
    parser.add_argument(
        "command",
        choices=("collect-initial", "analyze-initial", "collect-extension", "analyze-extended", "dry-run"),
    )
