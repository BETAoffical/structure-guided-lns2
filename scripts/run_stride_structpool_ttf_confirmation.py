...
from experiments.stride_structpool_ttf_confirmation import (  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the StructPool four-seed TTF confirmation.")
    ...
    if arguments.command == "analyze":
        report = analyze_structpool_ttf_confirmation(arguments.config, arguments.output)
    else:
        report = run_structpool_ttf_confirmation(
            arguments.config,
            arguments.output,
