...
from experiments.stride_structpool_ttf_quick import (  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the paired StructPool raw-TTF Quick.")
    ...
    if arguments.command == "analyze":
        report = analyze_structpool_ttf_quick(arguments.config, arguments.output)
    else:
        report = run_structpool_ttf_quick(
            arguments.config,
            arguments.output,
