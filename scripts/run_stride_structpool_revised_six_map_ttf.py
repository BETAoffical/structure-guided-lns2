...
from experiments.stride_structpool_revised_six_map_ttf import (  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run the preregistered revised six-map paired raw-TTF diagnostic."
    )
    ...
    if arguments.command == "analyze":
        report = analyze_revised_six_map_ttf(arguments.config, arguments.output)
    else:
        report = run_revised_six_map_ttf(
            arguments.config,
            arguments.output,
