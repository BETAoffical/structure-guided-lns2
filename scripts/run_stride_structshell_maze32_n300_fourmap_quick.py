...
from experiments.stride_structshell_maze32_n300_fourmap_quick import (  # noqa: E402
    analyze,
    plan,
    run,
)
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run the Maze32 N300 four-map, four-arm StructShell quick triage."
    )
