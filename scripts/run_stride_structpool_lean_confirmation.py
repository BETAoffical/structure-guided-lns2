...
from experiments.stride_structpool_lean_confirmation import (  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run the label-map-disjoint four-controller LeanPool confirmation."
    )
    ...
    if arguments.command == "analyze":
        report = analyze_structpool_lean_confirmation(
