...
from experiments.stride_guardpool_maze_regression import (  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run the frozen known-Maze GuardPool regression."
    )
    ...
    if arguments.command == "analyze":
        ...
        report = run_guardpool_maze_regression(
            arguments.config,
            arguments.output,
    ...
    return 0 if arguments.dry_run or report.get("regression_passed", True) else 1
