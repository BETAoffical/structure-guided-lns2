...
from experiments.stride_topology_boundary_quality import (  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run the paired immediate-quality STRIDE topology-boundary Pilot."
    )
    ...
    if arguments.mode == "collect":
        ...
        report = collect_topology_boundary_quality_pilot(
        ...
        report = analyze_topology_boundary_quality_pilot(
