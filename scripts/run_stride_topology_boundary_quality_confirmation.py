...
from experiments.stride_topology_boundary_quality_confirmation import (  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run the paired eight-seed topology-boundary confirmation."
    )
    ...
    if arguments.mode == "collect":
        ...
        report = collect_topology_boundary_quality_confirmation(
        ...
        report = analyze_topology_boundary_quality_confirmation(
