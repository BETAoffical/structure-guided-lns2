...
from experiments.movingai_probe_quality import audit_probe_quality  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument(
        "--probe-config", default="configs/movingai_mechanism_probe_dataset.json"
    )
    parser.add_argument(
        "--quality-config", default="configs/movingai_probe_quality_audit.json"
    )
