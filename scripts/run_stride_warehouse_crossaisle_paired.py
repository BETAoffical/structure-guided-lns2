...
from experiments.stride_warehouse_crossaisle_paired import (  # noqa: E402
    plan,
    prepare_q0,
    qualify,
    run,
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Prepare and reset-qualify the independent paired Warehouse "
            "cross-aisle benchmark. This runner cannot execute a controller, "
            "a policy episode, or formal TTF collection."
        )
    )
