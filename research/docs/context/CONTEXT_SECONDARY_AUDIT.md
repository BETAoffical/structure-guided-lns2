...
```powershell
python research/scripts/context/run_context_confirmation.py `
...
`research/configs/context/context_confirmation_dataset.json` and
`research/configs/context/context_confirmation_collection.json`. It can only be activated after a
