...
python scripts/generate_dataset.py `
  --config research/configs/neighborhood/independent_layout_probe_dataset.json
```
...
python scripts/collect_repair_experience.py `
  ...
  --config research/configs/neighborhood/independent_layout_probe_collection.json `
  --output build/initlns-independent-layout-probe-v1-collection `
  --phase qualify --splits probe --workers 4

python research/scripts/neighborhood/analyze_independent_layout_probe.py `
  --dataset build/initlns-independent-layout-probe-v1 `
