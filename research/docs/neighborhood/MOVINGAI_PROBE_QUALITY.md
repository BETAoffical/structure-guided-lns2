...
```powershell
python research/scripts/neighborhood/audit_movingai_probe_quality.py `
...
```powershell
python research/scripts/neighborhood/prepare_movingai_probe.py `
  --dataset build/movingai-dev `
  --config research/configs/neighborhood/movingai_mechanism_probe_v2_dataset.json `
...
python research/scripts/neighborhood/audit_movingai_probe_quality.py `
  ...
  --probe-config research/configs/neighborhood/movingai_mechanism_probe_v2_dataset.json `
