...
```powershell
python research/scripts/sequential/run_repair_order_probe.py --phase diagnose
python research/scripts/sequential/run_repair_order_probe.py --phase dry-run
```

Native collection runs in WSL:

```bash
PYTHONPATH=build/linux/project python3 research/scripts/sequential/run_repair_order_probe.py \
