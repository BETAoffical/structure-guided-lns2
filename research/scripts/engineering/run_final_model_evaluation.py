...
from research.engineering.legacy_tradeoff.final_model_evaluation import (  # noqa: E402
    POLICY_ORDER,
...
def _preflight(
    ...
    _run_command(
        [
            ...
            "-m",
            "unittest",
            "tests.runtime.test_closed_loop_trace_storage",
            "tests.runtime.test_closed_loop_confirmation",
            "tests.runtime.test_controller_v2",
            "tests.research.engineering.test_final_model_evaluation",
            "tests.research.engineering.test_lns2_tradeoff",
        ],
        logger,
    )
