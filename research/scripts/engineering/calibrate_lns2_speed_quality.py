...
from research.engineering.balanced.lns2_speed_quality_calibration import (  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument(
        "--collection-config",
        default="research/configs/policy/policy_visited_natural_collection.json",
    )
    parser.add_argument(
