...
from research.studies.representation.model_capacity_audit import run_model_capacity_audit  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--config", default="research/configs/representation/model_capacity_audit.json")
