...
from research.studies.neighborhood.realized_ranking_confirmation_analysis import (  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument(
        "--config", default="research/configs/neighborhood/realized_ranking_confirmation_analysis.json"
    )
