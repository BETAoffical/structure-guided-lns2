...
from research.studies.neighborhood.independent_layout_probe import (  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument(
        "--quality-config",
        default="research/configs/neighborhood/independent_layout_probe_quality.json",
    )
