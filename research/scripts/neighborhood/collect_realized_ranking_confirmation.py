...
from research.studies.neighborhood.realized_ranking_confirmation import (  # noqa: E402
    CollectionLockError,
...
def main() -> int:
    ...
    parser.add_argument(
        "--config", default="research/configs/neighborhood/realized_ranking_confirmation_collection.json"
    )
